...
class CookiputRecipeCreator:
    ...
    def create_recipe(self, recipe_name):
        ...
        response = requests.post(create_recipe_url, json=create_recipe_data, headers=self.headers, cookies=self.cookies)
    ...
    def add_ingredients(self, recipe_id, ingredients):
        ...
        response = requests.patch(add_ingredients_url, json=data, headers=self.headers, cookies=self.cookies)
    ...
    def add_steps(self, recipe_id, steps):
        ...
        response = requests.patch(add_steps_url, json=data, headers=self.headers, cookies=self.cookies)

    def add_tools_and_time(self, recipe_id, tools, total_time, prep_time, yield_value, yield_unit):
        ...
        response = requests.patch(add_tools_time_url, json=data, headers=self.headers, cookies=self.cookies)
